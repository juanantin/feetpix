...
export const features = [
  {
    icon: "feet" as const,
    title: "Legendary Origins",
    body: "Born from the iconic FEETPIX NFT collection that started it all.",
  },
  {
    icon: "coin" as const,
    title: "Community First",
    body: "Built for the culture. Powered by the community.",
  },
  {
    icon: "chart" as const,
    title: "Onchain Again",
    body: "A legendary collection enters its next chapter on Robinhood Chain.",
  },
  {
